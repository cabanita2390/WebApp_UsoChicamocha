...
/**
 * Columnas del historial de Tanqueo (combustibles, Fase 4 Task 18).
 ...
 */
export const createRefuelingColumns = (fuelTypesById = {}, unidadMedidaById = {}) => [
 ...
 */
export const createFuelPerformanceColumns = () => [
    {
        header: 'Elemento',
        accessorFn: (row) => (row.machineId != null ? `Máquina #${row.machineId}` : `Vehículo #${row.vehicleId}`),
        id: 'perf_elemento',
    ...
    { header: 'Horómetro/Km ejecutado', accessorKey: 'ejecutado', size: 130 },
    {
        header: 'Consumo estándar',
